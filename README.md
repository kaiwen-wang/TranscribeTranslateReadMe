...
<h2>TranscribeTranslate</h2>
<p>This is the go-to app for any live transcription content.</p>
...
<sub><b>The <a href="https://github.com/waydabber/BetterDisplay/releases">latest app version</a> requires macOS Sequoia (15).<br>
...
At the moment, it simply transcribes the system microphone while translating it, all live.

I aim for a small-scoped app with few bugs and good UX. There are floating captions available, making the app suited for presenting in another language.

It is possible to listen to system audio using a loopback driver such as Blackhole, but I believe this is bad UX, so the next iteration will have an option for system audio.

### The mid-term vision

Because I take calls in other languages, I needed a tool that would transcribe what the other person is saying live so that I could understand and remember what they are saying.

By calls, I might mean Zoom or Google Meet calls, WhatsApp, Signal, Telegram, or WeChat because they all have desktop apps.

At this stage, it should be possible to open any YouTube video and see live transcriptions/translations.

Furthermore, the actual sound content will be recorded to a file and can be play-backed because the transcript may not be perfectly accurate.

### The long-term

Because digital meetings are becoming ubiqutious, having an app that integrates with the rest of one's ecosystem, so that they can figure out exactly what someone said and when, in addition to any notes taken, is the vision I want to put forth.

There is no reason why this app also couldn't also serve as management of in-person meeting recordings as well, such as for journalists.

A screen capturing functionality, so that it's not just a transcript but also so the content of the screen is preserved, may also be ideal. By integrating this with an iPhone camera, someone could have both the audio and video content of live lectures.

If it moves more toward a language learning app, I'd like for it to select specific words to export them to an Anki deck.



### The far future

When all the basic requirements of the MacOS app are met, I can imagine a variety of directions, which will depend on what people want:

- More aesthetic design (currently it is utilitarian yet functional UX)
- Diarization of speakers
- iOS/iPad versions of the app
- A Windows and Linux version of the app
